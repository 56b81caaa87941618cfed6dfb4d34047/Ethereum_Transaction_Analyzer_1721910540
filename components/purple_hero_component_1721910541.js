...
Vue.component("purple_hero_component_1721910541", {
    template: `
        ...
        <div id="hero-content-container" class="pt-32 pb-16 md:pt-52 md:pb-32">
            ...
            <div id="hero-content" class="max-w-3xl mx-auto text-center" style="position: relative; z-index: 1">
                ...
                <div class="flex" id="sub-hero-text-container">
                    <p id="sub-hero-text" class="flex-1 text-lg mb-8 text-slate-300" data-aos="fade-down" data-aos-delay="200">Gain valuable intelligence on the latest Ethereum blockchain activity with our powerful transaction analysis app. Monitor, track, and dissect new transactions as they occur.</p>
                </div>
